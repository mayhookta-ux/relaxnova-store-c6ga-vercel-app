...
const legalPages: Record<LegalPageKey, { title: string; intro: string; sections: { heading: string; body: string[] }[] }> = {
  ...
  "contact-us": {
    ...
    sections: [
      { heading: "Customer support", body: [`Email: ${businessInfo.email}`, `Phone/contact: ${businessInfo.phone}`, `Business mailing address: ${businessInfo.address}`, "Recommended support hours placeholder: Monday–Friday, 9:00 AM–5:00 PM ET, excluding major US holidays.", "Response time: We aim to respond within 1–3 business days. Order investigations, carrier reviews, payment disputes, and return eligibility checks may require additional time."] },
