...
const legalPages: Record<LegalPageKey, { title: string; intro: string; sections: { heading: string; body: string[] }[] }> = {
  ...
  "terms-of-service": {
    ...
    sections: [
      ...
      { heading: "Order fulfillment", body: ["Orders may be fulfilled by logistics and delivery partners. Product handling, processing, shipment routing, tracking updates, and delivery timing may depend on inventory, carrier capacity, destination, customs, and operational conditions.", "Packaging, small presentation details, and tracking carriers may vary while remaining consistent with the product ordered."] },
      { heading: "Intellectual property and copyright", body: ["All RelaxNova store content, branding, design, text, product presentation, images, custom materials, page layouts, support copy, and other store assets belong to RelaxNova unless otherwise stated or licensed from authorized service providers.", "Unauthorized copying, reproduction, distribution, scraping, republication, modification, resale, or commercial use of RelaxNova materials without written permission is prohibited. Violations may result in appropriate legal action under applicable intellectual property, copyright, trademark, and unfair competition laws."] },
      { heading: "Limitation of liability", body: ["To the maximum extent allowed by law, our store, owners, operators, fulfillment partners, payment processors, and service providers are not liable for indirect, incidental, consequential, special, punitive, or exemplary damages, including lost profits, health claims, business interruption, delivery delays, or third-party service failures.", "Our total liability for any claim related to an order will not exceed the amount paid for the specific product giving rise to the claim, unless applicable law requires otherwise."] },
  ...
  "shipping-policy": {
    ...
    intro: "This Shipping Policy explains realistic processing, tracking, and delivery expectations for RelaxNova orders.",
    sections: [
      { heading: "Processing timeline", body: ["Most orders enter fulfillment review within 1–3 business days after payment approval. During high-volume periods, holidays, inventory checks, address verification, inventory backlogs, or carrier disruptions, processing may take up to 5 business days before active carrier movement begins.", "Business days exclude weekends and major US holidays. If we identify a payment, inventory, compliance, or address issue, we may contact you before shipment or cancel and refund the order when fulfillment is not possible."] },
      { heading: "US delivery estimate", body: ["Current US delivery estimate: typically 8–23 calendar days after processing, unless a different estimate is clearly shown at checkout or in order communication. Some orders may arrive sooner, while remote areas or carrier disruptions may take longer.", "Delivery estimates are not guaranteed delivery dates. The estimate includes routing, carrier transfer time, customs or security screening when relevant, and last-mile delivery movement."] },
      { heading: "Tracking updates", body: ["Orders may be processed and shipped through logistics partners. This allows us to offer a focused product at a lower price, but shipping timelines may be longer than domestic warehouse delivery.", "Tracking information is provided when available from the fulfillment and carrier network. Tracking scans may take 3–7 days to update after a label or logistics record is created, especially while the package transfers between fulfillment and carrier networks."] },
      { heading: "Shipping support", body: [`For RelaxNova shipping support, email ${businessInfo.email} with your order number, checkout email, delivery ZIP code, and tracking concern so our team can review the shipment details.`, "Please allow normal tracking scan delays before requesting an investigation, especially during carrier handoff periods."] },
  ...
  "contact-us": {
    ...
    sections: [
      ...
      { heading: "Response expectations", body: ["We aim to respond to customer support messages within 1–3 business days. Complex shipping investigations, carrier claims, payment disputes, and return reviews may take longer.", "Sending repeated messages may move your request down the queue if it creates duplicate tickets. Please reply in the same email thread whenever possible."] },
