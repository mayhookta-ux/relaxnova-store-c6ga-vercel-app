...
export const products: Product[] = [
  {
    ...
    price: 329,
    compareAt: 429,
    subtitle: "Champagne-toned facial device created to make nightly care feel calm, structured and easy to repeat.",
    description: "A premium at-home light care device with four selectable settings, a cushioned inner feel and a short guided session for customers who want daily self-care to feel more intentional, polished and comfortable.",
    bullets: ["Four selectable light modes", "Comfort-focused inner surface", "10-minute guided session", "Vanity-ready premium finish"],
    details: "Includes device, adjustable strap, USB-C cable, soft storage sleeve and an original quick-start care card.",
    shipping: "Ready-to-pack units can leave during the active fulfilment window. Tracked delivery is included for qualifying carts.",
  ...
  },
  {
    ...
    price: 92,
    subtitle: "Frosted-glass serum with a smooth, cushion-like finish for refined daily layering.",
    description: "A lightweight finishing serum created to follow cleansing or device care, adding glide, softness and a composed skin feel before moisturizer.",
  ...
  },
  {
    ...
    price: 128,
    compareAt: 168,
    subtitle: "Ivory prep wand with gentle pulse settings for a cleaner-feeling start to the ritual.",
  ...
  },
  {
    ...
    price: 68,
    subtitle: "Pink cooling roller with warm metal hardware for a soothing finishing step.",
    description: "A dual-ended sculpting roller designed for serum glide, gentle facial massage and a quiet morning or evening finish that makes the routine feel complete.",
