...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 92,
    subtitle: "Frosted-glass serum with a smooth, cushion-like finish for daily layering.",
    description: "A lightweight finishing serum created to follow cleansing or device care, adding slip, softness and a composed skin feel before moisturizer.",
  ...
  },
  {
    ...
    price: 128,
    compareAt: 168,
    subtitle: "Ivory prep wand with gentle pulse settings and warm metal detailing.",
    description: "A water-resistant cleansing prep tool with three pulse levels, a balanced handle and a clean silhouette for shoppers who want their routine to feel orderly and elevated.",
  ...
  },
  {
    ...
    price: 68,
    subtitle: "Pink cooling roller with warm metal hardware for a composed finishing step.",
    description: "A dual-ended sculpting roller designed for serum glide, gentle facial massage and a quiet morning or evening finishing ritual.",
